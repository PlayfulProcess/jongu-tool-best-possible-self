...
// Mock data for local development - replace with real API call to jongu-wellness
// when the tarot channel is implemented there
...
export async function GET() {
  // Return list of published decks
  const decks = MOCK_DECKS.map(deck => ({
    id: deck.id,
    name: deck.name,
